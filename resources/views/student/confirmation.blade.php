...
<head>
    ...
    <style>
        body {
            ...
            min-height: 100vh; display: flex; align-items: center; padding: 2rem 1rem;
        }
        ...
        .receipt-header h4 { font-weight: 800; margin-bottom: 0.25rem; }
        .receipt-header p { opacity: 0.8; margin: 0; font-size: 0.9rem; }
        ...
        .btn-print:hover { border-color: #1a56db; color: #1a56db; }
        .btn-home {
        ...
        .btn-home:hover { background: #1447c0; color: #fff; }
